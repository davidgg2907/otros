...
{
    public $v_fields=array('roles.name', 'roles.description', 'roles.created_at', 'roles.updated_at', 'roles.status');
    ...
    public function getAdd(Request $request){
      ...
      $data = new $roles;
    	...
    	return view('admin/roles/add', ['config'=>$config,'data'=>$data, ]);
    }
    ...
    public function getEdit($id=''){
        ...
        if(count($data)){
          return view('admin/roles/edit', ['data'=>$data, 'config'=>$config ,]);
        } else{

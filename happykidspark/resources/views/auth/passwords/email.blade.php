...
<head>
    ...
    <title>Resetear Contraseña - {{ str_replace('_',' ',env('TITULO_APP')) }}</title>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index.html" class="brand-logo">
                                    ...
                                    <br/>
                                    <h2 class="brand-text text-primary ms-1">{{ str_replace('_',' ',env('TITULO_APP')) }}</h2>
                                </a>

                                <h4 class="card-title mb-1">Olvido su contraseña? 🔒</h4>
                                <p class="card-text mb-2">Escriba su correo electronico para enviar las instrucciones </p>

                                <form class="auth-forgot-password-form mt-2" role="form" method="POST" action="{{ route('password.email') }}" >
                                ...
                                <p class="text-center mt-2">
                                    <a href="{{ url('login') }}"> <i data-feather="chevron-left"></i> Iniciar Sesion </a>
                                </p>
                            </div>
                        </div>
                        <!-- /Forgot Password basic -->

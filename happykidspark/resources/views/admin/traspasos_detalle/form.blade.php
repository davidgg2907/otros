												...
												<div class="col-md-6">
													<div class="mb-1">
													 <div class="form-group">
													  <label for="traspaso_id" class="control-label"> Traspaso_id </label>
													    <input type="text" class="form-control" id="traspaso_id" name="traspaso_id"
													    value="{{{ isset($data->traspaso_id ) ? $data->traspaso_id  : old('traspaso_id') }}}">
													    <div class="label label-danger">{{ $errors->first("traspaso_id") }}</div>
												   </div>
													</div>
												</div>
												<!-- Traspaso_id End -->

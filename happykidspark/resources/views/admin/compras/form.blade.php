					...
					<div class="mb-1">
					 <div class="form-group">
						...
						<select class="form-control" id="proveedor_id" name="proveedor_id" required>
							...
							@foreach(\App\admin\Proveedores::where('status',1)->get() as $value)
					...
					<div class="mb-1">
					 <div class="form-group">
						<label for="fecha_compra" class="control-label"> Fecha de Compra </label>
							<input type="text" class="form-control flatpickr-basic flatpickr-input" id="fecha_compra" name="fecha_compra">
							<div class="label label-danger">{{ $errors->first("fecha_compra") }}</div>
					 </div>
					</div>
				</div>
				<!-- Fecha_compra End -->

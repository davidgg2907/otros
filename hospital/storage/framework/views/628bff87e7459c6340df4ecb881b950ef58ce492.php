              ...
              <div class="row">
                <form action="<?php echo url('/'); ?>/admin/citas/add" id="formValidation" method="post" enctype="multipart/form-data">
                  <?php echo e(csrf_field()); ?>
                      ...
                      value="<?php echo e(isset($data->hora ) ? $data->hora  : old('hora')); ?>"/>
										   <div class="label label-danger"><?php echo e($errors->first("hora")); ?></div>
									   </div>
										</div>
										<!-- Hora End -->
                      ...
                      <textarea class="form-control" id="comentarios" name="comentarios"><?php echo e(isset($data->comentarios ) ? $data->comentarios  : old('comentarios')); ?></textarea>
...
<script>
  ...
  $('#calendar').fullCalendar({
    ...
    eventClick: function(eventObj) {
      $.ajax({
    		url: "<?php echo e(url('admin/citas/ajax')); ?>/" +  eventObj.id,
    		dataType: 'json',
          ...
          $('#consultaUrl').attr('href',"<?php echo e(url('admin/consultas/add?cita_id=')); ?>" + eventObj.id);

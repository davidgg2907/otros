    ...
    <div class="white-box">
      ...
      <div class="pull-left">
        <?php if(Auth::user()->permisos->addRecord == 1) { ?>
          <a href="<?php echo e(url('/admin/asistentes/add')); ?>" class="btn btn-info ">
            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-md-4 col-sm-4 text-center">
                      <a href="<?php echo e(url('admin/asistentes/view/' . $value->id)); ?>">
                      <?php if($value->fotografia) { ?>
                        <img src="<?php echo e(asset('uploads/asistentes/' . $value->fotografia)); ?>" alt="user" class="img-circle img-responsive">
                      <?php } else { ?>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="pull-right">
                        <?php if(Auth::user()->permisos->editRecord == 1) { ?>
                          <a title="Actualizar Informacion" href="<?php echo e(url('admin/asistentes/edit/' . $value->id)); ?>" class="btn btn-twitter waves-effect waves-light">

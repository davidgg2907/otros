        ...
        <div class="panel-wrapper collapse in" aria-expanded="true">
          <div class="panel-body">
				...
				<div class="col-md-2">
					...
					value="<?php echo e(date('d/m/Y H:i:s')); ?>">
				...
				<div class="col-md-2">
					...
					<div class="label label-danger"><?php echo e($errors->first("tarjeta")); ?></div>
				</div>
				</div>
				<!-- Tarjeta End -->
				...
				<div class="col-md-3">
					...
					value="<?php echo e(isset($data->edad ) ? $data->edad  : old('edad')); ?>">
					<div class="label label-danger"><?php echo e($errors->first("edad")); ?></div>
				</div>
				</div>
				<!-- Edad End -->
				...
				<div class="col-md-3">
					...
					value="<?php echo e(isset($data->genero ) ? $data->genero  : old('genero')); ?>">
					<div class="label label-danger"><?php echo e($errors->first("genero")); ?></div>
				</div>
				</div>
				<!-- Genero End -->
				...
				<div class="col-md-3">
					...
					<div class="label label-danger"><?php echo e($errors->first("peso")); ?></div>
				</div>
				</div>
				<!-- Peso End -->
				...
				<div class="col-md-3">
					...
					<div class="label label-danger"><?php echo e($errors->first("talla")); ?></div>
				</div>
				</div>
				<!-- Talla End -->
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="domicilio" name="domicilio" value="<?php echo e(isset($data->domicilio ) ? $data->domicilio  : old('domicilio')); ?>">
						<div class="label label-danger"><?php echo e($errors->first("domicilio")); ?></div>
					</div>
				</div>
				<!-- Valoracion End -->
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="colonia" name="colonia" value="<?php echo e(isset($data->colonia ) ? $data->colonia  : old('colonia')); ?>">
						<div class="label label-danger"><?php echo e($errors->first("colonia")); ?></div>
					</div>
				</div>
				<!-- Valoracion End -->
				...
				<div class="col-md-2">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="cp" name="cp" value="<?php echo e(isset($data->cp ) ? $data->cp  : old('cp')); ?>">
          ...
          <div class="panel-body">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						value="<?php echo e(isset($data->doctor ) ? $data->doctor  : old('doctor')); ?>">
						<div class="label label-danger"><?php echo e($errors->first("doctor")); ?></div>
					</div>
				</div>
				<!-- Dr. Que Atendio End -->
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						value="<?php echo e(isset($data->enfermera ) ? $data->enfermera  : old('enfermera')); ?>">
						<div class="label label-danger"><?php echo e($errors->first("enfermera")); ?></div>
					</div>
				</div>
				<!-- Dr. Que Atendio End -->
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						value="<?php echo e(isset($data->jefa ) ? $data->jefa  : old('jefa')); ?>">
						<div class="label label-danger"><?php echo e($errors->first("jefa")); ?></div>
					</div>
				</div>
				<!-- Dr. Que Atendio End -->
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-wrapper collapse in" aria-expanded="true">
          <div class="panel-body">
			...
			<div class="col-md-12">
				<div class="form-group">
					<textarea rows="5" class="form-control" id="valoracion" name="valoracion"><?php echo e(isset($data->valoracion ) ? $data->valoracion  : old('valoracion')); ?></textarea>					
	...
	<div class="panel-wrapper collapse in" aria-expanded="true">
		<div class="panel-body">
			...
			<div class="col-md-12">
				...
				value="<?php echo e(isset($data->ta ) ? $data->ta  : old('ta')); ?>">
				<div class="label label-danger"><?php echo e($errors->first("ta")); ?></div>
			</div>
			</div>
			<!-- Ta End -->
			...
			<div class="col-md-12">
				...
				<div class="label label-danger"><?php echo e($errors->first("fr")); ?></div>
			</div>
			</div>
			<!-- Fr End -->
			...
			<div class="col-md-12">
				...
				<div class="label label-danger"><?php echo e($errors->first("fc")); ?></div>
			</div>
			</div>
			<!-- Fc End -->
			...
			<div class="col-md-12">
				...
				value="<?php echo e(isset($data->t ) ? $data->t  : old('t')); ?>">
				<div class="label label-danger"><?php echo e($errors->first("t")); ?></div>
			</div>
			</div>
			<!-- T End -->
			...
			<div class="col-md-12">
				...
				value="<?php echo e(isset($data->sp02 ) ? $data->sp02  : old('sp02')); ?>">
				<div class="label label-danger"><?php echo e($errors->first("sp02")); ?></div>
			</div>
			</div>
			<!-- Sp02 End -->
...
<div class="col-md-3">
	...
	<div class="panel-wrapper collapse in" aria-expanded="true">
		...
		<div class="col-md-12">
			...
			value="<?php echo e(isset($data->gcapilar ) ? $data->gcapilar  : '0'); ?>">
			<div class="label label-danger"><?php echo e($errors->first("gcapilar")); ?></div>
		</div>
		</div>
		<!-- Gcapilar End -->
		...
		<div class="col-md-12">
			...
			value="<?php echo e(isset($data->ocular ) ? $data->ocular  : '0'); ?>">
			<div class="label label-danger"><?php echo e($errors->first("ocular")); ?></div>
		</div>
		</div>
		<!-- Ocular End -->
		...
		<div class="col-md-12">
			...
			value="<?php echo e(isset($data->verbal ) ? $data->verbal  : '0'); ?>">
			<div class="label label-danger"><?php echo e($errors->first("verbal")); ?></div>
		</div>
		</div>
		<!-- Verbal End -->
		...
		<div class="col-md-12">
			...
			value="<?php echo e(isset($data->motriz ) ? $data->motriz  : '0'); ?>">
			<div class="label label-danger"><?php echo e($errors->first("motriz")); ?></div>
		</div>
		</div>
		<!-- Motriz End -->
		...
		<div class="col-md-12">
			...
			value="<?php echo e(isset($data->gtotal ) ? $data->gtotal  : old('gtotal')); ?>">
			<div class="label label-danger"><?php echo e($errors->first("gtotal")); ?></div>
		</div>
		</div>
		<!-- Gtotal End -->
	...
	<div class="panel-wrapper collapse in" aria-expanded="true">
		<div class="panel-body">
			...
			<div class="col-md-12">
				...
				value="<?php echo e(isset($data->diabetes ) ? $data->diabetes  : old('diabetes')); ?>">
				<div class="label label-danger"><?php echo e($errors->first("diabetes")); ?></div>
			</div>
			</div>
			<!-- Diabetes End -->
			...
			<div class="col-md-12">
				...
				value="<?php echo e(isset($data->hipertencion ) ? $data->hipertencion  : old('hipertencion')); ?>">
				<div class="label label-danger"><?php echo e($errors->first("hipertencion")); ?></div>
			</div>
			</div>
			<!-- Hipertencion End -->
			...
			<div class="col-md-12">
				...
				value="<?php echo e(isset($data->alergias ) ? $data->alergias  : old('alergias')); ?>">
				<div class="label label-danger"><?php echo e($errors->first("alergias")); ?></div>
			</div>
			</div>
			<!-- Alergias End -->
			...
			<div class="col-md-12">
				...
				value="<?php echo e(isset($data->fum ) ? $data->fum  : old('fum')); ?>">
				<div class="label label-danger"><?php echo e($errors->first("fum")); ?></div>
			</div>
			</div>
			<!-- Fum End -->
			...
			<div class="col-md-12">
				...
				value="<?php echo e(isset($data->ecardiacas ) ? $data->ecardiacas  : old('ecardiacas')); ?>">
				<div class="label label-danger"><?php echo e($errors->first("ecardiacas")); ?></div>
			</div>
			</div>
			<!-- Ecardiacas End -->
			...
			<div class="col-md-12">
				...
				value="<?php echo e(isset($data->otras ) ? $data->otras  : old('otras')); ?>">
				<div class="label label-danger"><?php echo e($errors->first("otras")); ?></div>
			</div>
			</div>
			<!-- Otras End -->			
		</div>

...
<div class="row">
  ...
  <div class="col-sm-12">
    ...
    <div class="white-box">
      ...
      <div class="pull-left">
        <a href="<?php echo e(url('/admin/ambulancias/add')); ?>" class="btn btn-info ">
          <i class="fa fa-plus fa-2x"></i><br/>Nuevo</a>
      </div>

      <div class="pull-right">
        <a href="<?php echo e(url('/admin/ambulancias/excel?' . $query)); ?>" class="btn btn-success" title="Exportar a Excel">
              ...
              <table class="table display" id="table-content">
                ...
                <?php foreach($data as $value) { ?>
                  <tr id="hide<?php $value->id; ?>" >
                    ...
                    <td> <?php echo e($value->servicio); ?> </td>
                    <td> <?php echo e($value->unidad); ?> </td>
                    <td> <?php echo e($value->chofer); ?> </td>
                    <td> <?php echo e($value->medico); ?> </td>
                    <td> <?php echo e($value->paciente); ?> </td>
                    <td> <?php echo e($value->origen); ?> </td>
                    <td> <?php echo e($value->destino); ?> </td>
                    <td>

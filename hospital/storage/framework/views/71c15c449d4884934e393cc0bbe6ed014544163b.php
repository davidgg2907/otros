    ...
    <div class="white-box">
      ...
      <div class="pull-left">
        <?php if(Auth::user()->permisos->addRecord == 1) { ?>
          <a href="<?php echo e(url('/admin/medicos/add')); ?>" class="btn btn-info ">
      				...
      				<div class="col-md-4">
      				 <div class="form-group">
      					<label for="especialidad" class="control-label"> Especialidad </label>
      						...
      						value="<?php echo e(isset($data->especialidad ) ? $data->especialidad  : old('especialidad')); ?>">
      						<div class="label label-danger"><?php echo e($errors->first("especialidad")); ?></div>
      				 </div>
      				</div>
      				<!-- Especialidad End -->
            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-md-4 col-sm-4 text-center">
                      <a href="<?php echo e(url('admin/medicos/view/' . $value->id)); ?>">
                      <?php if($value->fotografia) { ?>
                        <img src="<?php echo e(asset('uploads/medicos/' . $value->fotografia)); ?>" alt="user" class="img-circle img-responsive">
                      <?php } else { ?>
                    ...
                    <div class="col-md-8 col-sm-8">
                        <h3 class="box-title m-b-0" title="<?php echo e($value->nombre); ?>">
                          <a href="<?php echo e(url('admin/medicos/view/' . $value->id)); ?>"><?php echo e(substr($value->nombre,0,20)); ?>

                          </a>
                        </h3> <small><?php echo e($value->especialidad); ?></small>
                        <p> </p>
                        <address>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="pull-right">
                        ...
                        <a title="Actualizar Informacion" href="<?php echo e(url('admin/medicos/edit/' . $value->id)); ?>" class="btn btn-twitter waves-effect waves-light">

...
<div class="row">
  <form action="<?php echo url('/'); ?>/admin/ambulancias/edit" id="formValidation" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
      ...
      <?php echo $__env->make('admin.ambulancias.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
  </form>
</div>

...
<div style="width:99%; float: left; ">
  ...
  <tr>
    ...
    <tr>
      <td colspan="4" style="border:1px solid #0096C7; padding:5px; font-size:12px; height:70px; vertical-align:text-top;padding-top:10px;"><?php echo e($data->origen); ?></td>
      <td colspan="4" style="border:1px solid #0096C7; padding:5px; font-size:12px; height:70px; vertical-align:text-top;padding-top:10px;"><?php echo e($data->destino); ?></td>
    </tr>
    <tr>
      <td colspan="8" style="border:1px solid #0096C7; padding:5px; font-size:12px; background: #BCDFE6; font-weight:bold">Diagnostico</td>
    </tr>
    <tr>
      <td colspan="8" style="border:1px solid #0096C7; padding:5px; font-size:12px; height:250px; vertical-align:text-top;padding-top:10px;"><?php echo e($data->diagnostico); ?></td>
    </tr>
    <tr>
      <td colspan="8" style="border:1px solid #0096C7; padding:5px; font-size:12px; background: #BCDFE6; font-weight:bold">Comentarios</td>
    </tr>
    <tr>
      <td colspan="8" style="border:1px solid #0096C7; padding:5px; font-size:12px; height:250px; vertical-align:text-top;padding-top:10px;"><?php echo e($data->comentario); ?></td>
    </tr>
    <tr>

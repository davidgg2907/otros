	...
	<div class="panel panel-default">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body" style="padding:0px">
				...
				<div class="label label-danger"><?php echo e($errors->first("fotografia")); ?></div>
				<!-- Fotografia End -->
			</div>
		</div>
	</div>
			...
			<div class="panel-body">
				...
				<div class="col-md-6">
				 <div class="form-group">
					...
					value="<?php echo e(isset($data->nacimiento ) ? $data->nacimiento  : old('nacimiento')); ?>">
					<div class="label label-danger"><?php echo e($errors->first("nacimiento")); ?></div>
				 </div>
				</div>
				<!-- Nacimiento End -->
				...
				<div class="col-md-12">
				 <div class="form-group">
					...
					<textarea class="form-control" id="domicilio" name="domicilio"><?php echo e(isset($data->domicilio ) ? $data->domicilio  : old('domicilio')); ?></textarea>
	...
	<div class="panel panel-default">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<div class="col-md-12">
				 <div class="form-group">
						<textarea class="form-control summernote" id="hereditarias" name="hereditarias"><?php echo e(isset($data->hereditarias ) ? $data->hereditarias  : old('hereditarias')); ?></textarea>
						<div class="label label-danger"><?php echo e($errors->first("hereditarias")); ?></div>
				 </div>
				</div>
				<!-- Hereditarias End -->
			</div>
	...
	<div class="panel panel-default">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<div class="col-md-12">
				 <div class="form-group">
					<textarea class="form-control summernote" id="alergias" name="alergias"><?php echo e(isset($data->alergias ) ? $data->alergias  : old('alergias')); ?></textarea>
	...
	<div class="panel panel-default">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<div class="col-md-12">
				 <div class="form-group">
					<textarea class="form-control summernote" id="cirugias" name="cirugias"><?php echo e(isset($data->cirugias ) ? $data->cirugias  : old('cirugias')); ?></textarea>
					<div class="label label-danger"><?php echo e($errors->first("cirugias")); ?></div>
				 </div>
				</div>
				<!-- Cirugias End -->
			</div>
	...
	<div class="panel panel-default">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<div class="col-md-12">
				 <div class="form-group">
					<textarea class="form-control summernote" id="mymce" name="vicios"><?php echo e(isset($data->vicios ) ? $data->vicios  : old('vicios')); ?></textarea>
					<div class="label label-danger"><?php echo e($errors->first("vicios")); ?></div>
				 </div>
				</div>
				<!-- Vicios End -->
	...
	<div class="panel panel-default">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<div class="col-md-12">
				 <div class="form-group">
					<textarea class="form-control summernote" id="mymce" name="diagnostico"><?php echo e(isset($data->diagnostico ) ? $data->diagnostico  : old('diagnostico')); ?></textarea>
	...
	<div class="panel panel-default">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<div class="col-md-12">
				 <div class="form-group">
					<textarea class="form-control summernote" id="mymce" name="tratamiento"><?php echo e(isset($data->tratamiento ) ? $data->tratamiento  : old('tratamiento')); ?></textarea>

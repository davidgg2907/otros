    ...
    <div class="white-box">
      ...
      <div class="pull-left">
        <?php if(Auth::user()->permisos->addRecord == 1) { ?>
          <a href="<?php echo e(url('/admin/cuartos/add')); ?>" class="btn btn-info ">
        				...
        				<div class="col-md-3">
        				 <div class="form-group">
        				  <label for="numero" class="control-label"> Nro Habitacion </label>
        				    ...
        				    value="<?php echo e(isset($data->numero ) ? $data->numero  : old('numero')); ?>">
        				    <div class="label label-danger"><?php echo e($errors->first("numero")); ?></div>
        				 </div>
        				</div>
        				<!-- Numero End -->
              ...
              <table class="table display" id="table-content">
                ...
                <?php foreach($data as $value) { ?>
                  <tr id="hide<?php $value->id; ?>" >
					            <td> <?php echo e($value->numero); ?> </td>
					            <td> <?php echo e($value->descripcion); ?> </td>
					            <td> <?php echo e($value->amenidades); ?> </td>
					            <td> <?php echo e($value->equipo); ?> </td>
					            <td> $ <?php echo e(number_format($value->costo_dia,2,".",",")); ?> </td>
                      <td>
                        <?php
                          switch($value->status) {
                            case 1:

...
<div class="row">
  ...
  <div class="col-sm-12">
    ...
    <div class="white-box">
      ...
      <div class="pull-left">
        <a href="<?php echo e(url('/admin/consultas/add')); ?>" class="btn btn-info ">
              ...
              <table class="table display" id="table-content">
                ...
                <?php foreach($data as $value) { ?>
                  <tr id="hide<?php $value->id; ?>" >
                    ...
                    <td> <?php echo $value->razon_visita; ?> </td>
                    <td> <?php echo $value->diagnostico; ?> </td>
                    <td>
                      <?php if(Auth::user()->permisos->viewRecord == 1) { ?>
                        <?php if(count($value->receta)) { ?>
                           <button onclick="imprime(<?php echo e($value->receta->id); ?>,2)" type="button" data-toggle="tooltip" style="border:0px; background:none" title="Imprimir Receta Medica">
                      ...
                      <?php if(Auth::user()->permisos->viewRecord == 1) { ?>
                        <button onclick="imprime(<?php echo e($value->id); ?>,1)" type="button" data-toggle="tooltip" style="border:0px; background:none" title="Imprimir Ficha de consulta0">
...
<script>
  ...
  function imprime(id,tipo) {
    ...
    var url = "";
    if(tipo == 1) {
      url = "<?php echo e(url('admin/consultas/ficha/')); ?>/" + id
    } else {
      url = "<?php echo e(url('admin/recetas/print/')); ?>/" + id
    }

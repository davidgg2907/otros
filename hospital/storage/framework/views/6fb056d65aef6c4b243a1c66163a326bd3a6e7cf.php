  ...
  <div class="col-sm-12">
      <div class="white-box">
        <div class="pull-left">
          ...
          <a href="<?php echo e(url('admin/pacientes/ficha/' . $data->id)); ?>" target="_blank" class="btn btn-primary" title="Imprimir Ficha">
            ...
            <div class="modal-body">
              <div class="row">
                <form action="<?php echo url('/'); ?>/admin/notas/add" id="formValidation" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="redirect" id="redirect" value="admin/pacientes/view/<?php echo e($data->id); ?>"/>
                  <input type="hidden" name="paciente_id" id="pacienteNotaId" value="<?php echo e($data->id); ?>"/>
                    ...
                    <!-- Comentarios Start -->
                      ...
                      <select id="tipo" name="tipo" class="form-control">
                        <option value=""> [-SELECCIONE-] </option>
                        <option value="1"> Analisis de Laboratorio </option>

...
<div class="row">
  <form action="<?php echo url('/'); ?>/admin/triaje/edit" id="formValidation" method="post" enctype="multipart/form-data">
    ...
    <?php echo $__env->make('admin.triaje.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

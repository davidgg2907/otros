				...
				<div class="col-md-8">
					<div class="form-group" <?php if(!$general_view) { echo 'style="display:block"'; }?>>
							...
							<?php } else { ?>
								...
								<input type="hidden" class="form-control" name="doctor_id" id="medico_id" value="{{ Auth::user()->medico_id }}" />
			...
			<div class="panel-body">
				...
				<div class="col-md-12">
				 <div class="form-group">
					 ...
					 <input type="hidden" class="form-control" id="recomendaciones" name="recomendaciones" value="{{{ isset($data->recomendaciones ) ? $data->recomendaciones  : old('recomendaciones') }}}"/>
	...
	<div class="panel panel-default">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<div class="col-md-12">
				 <div class="form-group">
					 <textarea class="form-control summernote" id="tratamiento" name="tratamiento">{{{ isset($data->tratamiento ) ? $data->tratamiento  : old('tratamiento') }}}</textarea>

  ...
  <table style="font-size: 10px; width:100%">
    <tbody>
      <tr>
        ...
        <td style="border-bottom:1px solid #999999; text-align:center">{{ $consulta->fc }}</td>
        <td style="width:3%">F.R.</td>
        <td style="border-bottom:1px solid #999999; text-align:center">{{ $consulta->fr }}</td>
        <td style="width:2%">T.</td>
        <td style="border-bottom:1px solid #999999; text-align:center">{{ $consulta->temperatura }}</td>
        <td style="width:5%">Peso</td>
        <td style="border-bottom:1px solid #999999; text-align:center">{{ $consulta->peso }} Kg.</td>
        <td style="width:5%">Talla</td>
        <td style="border-bottom:1px solid #999999; text-align:center">{{ $consulta->talla }} C.m</td>
        <td style="width:3%">T/A</td>
        <td style="border-bottom:1px solid #999999; text-align:center"> {{ $consulta->ta1 }}/ {{ $consulta->ta2 }} </td>
        <td style="width:5%">Sat O <sup>2</sup></td>
        <td style="border-bottom:1px solid #999999; text-align:center">{{ $consulta->sato2 }} %</td>
      </tr>
    </tbody>
  </table>
</div>

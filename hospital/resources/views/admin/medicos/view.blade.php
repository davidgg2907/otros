          ...
          <div class="white-box">
              <div class="user-bg">
                <?php if($data->fotografia) { ?>
                  <img width="100%" alt="user" src="<?php echo asset('uploads/medicos/' . $data->fotografia)?>">
                <?php } else { ?>
              ...
              <div class="user-btm-box">
                  ...
                  <!-- .row -->
                  <div class="row text-center m-t-10">
                      <div class="col-md-6 b-r"><strong>Especialidad</strong>
      ...
      <div class="col-md-8 col-xs-12">
          <div class="white-box">
              ...
              <ul class="nav nav-tabs tabs customtab">
                  ...
                  <li class="tab">
                      <a href="#biography" data-toggle="tab"> <span class="visible-xs"><i class="fa fa-home"></i></span> <span class="hidden-xs">Mis Pacientes</span> </a>
                  </li>
                  <li class="tab">

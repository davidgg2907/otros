                  ...
                  <tr id="hide<?php $value->id; ?>" >
                    ...
                    <td>
                      ...
                      <?php if(Auth::user()->permisos->viewRecord == 1) { ?>
                        <a href="{{ url('admin/pacientes/laboratorio/ficha/' . $value->id) }}" target="_blank" type="button" data-toggle="tooltip" style="border:0px; background:none" title="Imprimir Ficha de signos vitales">

...
<div style="width:49%; float: left; text-align:right; margin-bottom: 10px; font-size: 11px;">
  ...
  <h3>URGENCIA: <span style="color: {{ $color }}">{{ $data->tarjeta }}</span> </h3>
...
<div style="width:98%; margin-top:20px; padding-left:10px; padding-right:10px; padding-top:10px; padding-bottom:10px font-size: px; background: #CCC; height:100px;">
	...
	<table style="width:100%;" cellpadding="1" cellspacing="10">
		<tr>
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>No Folio:</strong> {!! $data->id !!}</td>			
			<td colspan="2" style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>FECHA;</strong> {!! $data->fecha !!}</td>
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>HORA:</strong> {!! $data->hora !!}</td>
		</tr>

		<tr>
			<td colspan="4" style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>NOMBRE DEL PACIENTE:</strong> {!! $data->paciente !!}</td>
		</tr>

		<tr>
			<td colspan="4" style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>DOMICILIO:</strong> {!! $data->domicilio !!} {!! $data->colonia !!} {!! $data->cp !!}</td>
		</tr>


		<tr>
			<td colspan="4" style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>MEDICO:</strong> {!! $data->doctor !!} </td>
		</tr>

		<tr>
			<td colspan="4" style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>ENFERMERA:</strong> {!! $data->enfermera !!} </td>
		</tr>

		<tr>
			<td colspan="4" style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>JEFA:</strong> {!! $data->jefa !!} </td>
		</tr>


		<tr>
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>EDAD:</strong> {!! $data->edad !!}</td>
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>GENERO:</strong> {!! $data->genero !!}</td>
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>PESO:</strong> {!! $data->peso !!}</td>
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px; font-size:12px;"><strong>TALLA:</strong> {!! $data->talla !!}</td>
		</tr>
...
<div style="width:98%; margin-top:20px; padding-left:10px; padding-right:10px; padding-top:10px; padding-bottom:10px; background: #CCC; height:100px;">
	...
	<table style="width:100%;" cellpadding="1" cellspacing="10">
		<tr>
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px;  font-size:12px;"><strong>TA:</strong> {!! $data->ta !!}</td>
			<td style="width:20%"><p></br></p></td>			
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px; "><strong>T*:</strong> {!! $data->t !!}</td>
		</tr>
		<tr>
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px;  font-size:12px;"><strong>FR:</strong> {!! $data->fr !!}</td>
			<td><p></br></p></td>	
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px;  font-size:12px;"><strong>SP02:</strong> {!! $data->sp02 !!}</td>
		</tr>
		<tr>
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px;  font-size:12px;"><strong>FC:</strong> {!! $data->fc !!}</td>
			<td><p></br></p></td>	
			<td style="background: #FFF; border:1px solid; #000; padding-left:10px;  font-size:12px;"><strong>GLUCOSA CAPILAR:</strong> {!! $data->gcapilar !!}</td>
		</tr>
	</table>
...
<div style="width:98%; margin-top:20px; padding-left:10px; padding-right:10px; padding-top:10px; background: #CCC;">
	...
	<table style="width:100%;" cellpadding="1" cellspacing="10">
		<tr>
			...
			<td style="background: #FFF; border:1px solid; #000; padding-left:5px; font-size: 12px;">{!! $data->ocular !!}</td>
			<td style="font-size: 12px;"><strong>VERBAL:</strong></td>	
			<td style="background: #FFF; border:1px solid; #000; padding-left:5px; font-size: 12px; ">{!! $data->verbal !!}</td>
			<td style="font-size: 12px;"><strong>MOTRIZ:</strong></td>
			<td style="background: #FFF; border:1px solid; #000; padding-left:5px; font-size: 12px; ">{!! $data->motriz !!}</td>
			<td style="font-size: 12px;"><strong>TOTAL:</strong></td>
			<td style="background: #FFF; border:1px solid; #000; padding-left:5px; font-size: 12px; ">{!! $data->gtotal !!}</td>
	</tr>
	</table>

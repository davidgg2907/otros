...
<div class="row">
  ...
  <div class="col-sm-12">
    ...
    <div class="white-box">
      ...
      <div class="pull-left">
        <a href="{{ url('/admin/triaje/add') }}" class="btn btn-info ">
          <i class="fa fa-plus fa-2x"></i><br/>Nuevo</a>

      </div>

      <div class="pull-right">
        <a href="{{ url('/admin/triaje/excel' . $query) }}" class="btn btn-success" title="Exportar a Excel">

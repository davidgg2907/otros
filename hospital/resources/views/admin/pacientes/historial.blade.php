                        ...
                        <table style="font-size: 10px; width:100%">
                          <tbody>
                            ...
                            <tr style="">
                              ...
                              <td style="border-bottom:1px solid #999999; text-align:center;padding-top:10px;">{{ $data->talla }} C.m</td>
                              <td style="width:3%;padding-top:10px;">T/A</td>
                              <td style="border-bottom:1px solid #999999; text-align:center;padding-top:10px;"> {{ $data->ta1 }}/ {{ $data->ta2 }} </td>
                              <td style="width:5%;padding-top:10px;">Sat O <sup>2</sup></td>
                              <td style="border-bottom:1px solid #999999; text-align:center;padding-top:10px;">{{ $data->sato2 }} %</td>
                            </tr>
                          </tbody>
                        </table>
                      </p>
              ...
              <div class="white-box">
                <div class="row">
                  ...
                  <?php if($laboratorio->archivo) { ?><div class="col-md-3"><?php } else { ?> <div class="col-md-6 text-right"><?php } ?>
                    <a target="_blank" href="{{ url('admin/pacientes/laboratorio/ficha/' . $laboratorio->id) }}" class="btn btn-info"> <li class="fa fa-download fa-lg"></li> Descargar Ficha</a>
                  </div>
                  <?php if($laboratorio->archivo) { ?>
                    <div class="col-md-3">
                      <a target="_blank" href="{{ asset('uploads/Laboratorio/' . $laboratorio->archivo)}}" class="btn btn-primary"> <li class="fa fa-download fa-lg"></li> Descargar Archivo</a>
                    </div>
                  <?php } ?>
                </div>
              </div>

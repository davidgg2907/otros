                  ...
                  <tr id="hide<?php $value->id; ?>" >
                    ...
                    <td class="text-center">
                      ...
                      <?php if(Auth::user()->permisos->viewRecord == 1) { ?>
                        <!--<button onclick="imprime({{{ $value->id}}},1)" type="button" data-toggle="tooltip" style="border:0px; background:none" title="Imprimir Ficha de signos vitales">
...
function imprime(id) {
  ...
  var  url = "{{ url('admin/pacientes/signos/') }}/" + id

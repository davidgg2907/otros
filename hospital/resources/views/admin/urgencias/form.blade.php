				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
								...
								<input type="text" class="form-control" id="medico" name="medico" value="{{{ isset($data->medico ) ? $data->medico  : old('medico') }}}">
								<input type="hidden" name="medico_id" id="medico_id" value="0"/>
...
<div class="col-md-12">
	<div class="panel panel-default">
		<div class="panel-heading">Motivo de Urgencia</div>
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				<!-- Motivo Start -->
				<div class="col-md-12">
	...
	<div class="panel panel-default">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<div class="col-md-6">
				 <div class="form-group">
					<label for="heredo_leulin" class="control-label"> Otros </label>
...
<div class="col-md-12">
	<div class="panel panel-default">
		<div class="panel-heading">Insumos o servicios utilizados</div>
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">

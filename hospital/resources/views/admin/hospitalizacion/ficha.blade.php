...
<div class="row">
  <form action="<?php echo url('admin/hospitalizacion/servicios/'); ?>" id="formValidation" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="col-sm-12">
      <div class="white-box">
    ...
    <input type="hidden" class="form-control" name="hospitalizacion_id" value="{{ $data->id }}" />
            ...
            <div class="panel-body">
              ...
              <div class="row text-center m-t-10">
                <div class="col-md-6"><strong>F. Ingreso</strong>
                    <p>{{ $data->fecha_ingreso }}</p>
                </div>

                <div class="col-md-6"><strong>Habitacion Asignada</strong>
                    <p>{{ $data->Habitacion->numero }} {{ $data->Habitacion->descripcion }}</p>
                </div>
              ...
              <div class="row text-center m-t-10">
                <div class="col-md-12"><strong>M. Ingreso</strong>
                    <p> {!! $data->motivo !!}</p>
                </div>
    ...
    <div class="col-md-4">
      <div class="panel panel-default">
        ...
        <div class="panel-wrapper collapse in">
            <div class="panel-body">
              <?php $hospitalizacion = $data->habitacion->costo_dia * ($days != 0 ? $days : 1); ?>
              <div class="row">
                <div class="col-md-8 text-right">
                  <h3> C. HOSPITALIZACION </h3>
                  <small style="margin-top:-10px;">Dias: {{ $days != 0 ? $days : 1}}</small>
                </div>
                <div class="col-md-4" id="lblHospitalizacion">$ {{ number_format($hospitalizacion,2,".",",") }}</div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <small class="text-info">
                    NOTA: los datos referentes al servicio de habitacion, solo son informativos, estos costo_dia,
                    estos seran agregados al pago final una vez dado de alta el paciente
                  </small>
                </div>
              </div>
              ...
              <div class="row">
                  <!-- Medico_id Start -->
                    ...
                    <div class="input-group m-t-10">
          						...
          						<input type="text" class="form-control" name="txtAbono" id="txtAbono" value="<?php echo $data->pendiente - $data->pagado; ?>"/>
...
<script>
  ...
  function abonar() {
    ...
    var url = "{{ url('admin/hospitalizacion/abonar/' . $data->id)}}";
  ...
  function eliminaServicio(valor, tipo) {
    ...
    if(tipo == 1) {
      ...
      $.ajax({
    			url: "<?php echo url('admin/hospitalizacion/servicios/baja'); ?>/" + valor,
    			dataType: 'json',
    			contentType: "application/json; charset=utf-8",
    			success: function(json) {
  ...
  function filtrarServicios() {
    ...
    $.ajax({
        url: "<?php echo url('admin/hospitalizacion/fechas'); ?>/?desde=" + desde + "&hasta=" + hasta,
        dataType: 'json',
        contentType: "application/json; charset=utf-8",
        success: function(json) {

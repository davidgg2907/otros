...
class RecetasController extends Controller
{
    ...
    public function view($id){
      ...
      $consulta = \App\admin\Consultas::find($data->consulta_id);
      ...
      $pdf = PDF::loadView('admin/recetas/print', ['data'=>$data, 'config'=>$config,'empresa' => $empresa,'consulta' => $consulta],

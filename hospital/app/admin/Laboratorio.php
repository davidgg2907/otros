...
class Laboratorio extends Model
{
    ...
    public function getLaboratorioData($per_page, $request, $sortBy, $order){
      $laboratorio = Laboratorio::select(array('laboratorio.*' , 'pacientes.nombre AS pacientename' , 'medicos.nombre AS mediconame' , 'enfermeria.nombre AS enfermeraname'));
      ...
      //join
        ...
        $laboratorio->where('laboratorio.status',1);

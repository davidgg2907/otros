            ...
            {{ csrf_field() }}
              <table class='table table-bordered' style='width:70%;' align='center'>
										    ...
										    <!-- Enfermera_id End -->
															...
															<tr>
															 <td>
															   <label for="hospitalizacion_id" class="col-sm-3 control-label"> Hospitalizacion_id </label>
															 </td>
															 <td>
															   {{{ $data->hospitalizacion_id }}}
															 </td>
															</tr>
															<tr>
															 <td>
															...
															<tr>
															 <td>
															   <label for="presion" class="col-sm-3 control-label"> Presion </label>
															 </td>
															 <td>
															   {{{ $data->presion }}}
															 </td>
															...
															<tr>
															 <td>
															   <label for="temperatura" class="col-sm-3 control-label"> Temperatura </label>
															 </td>
															 <td>
															   {{{ $data->temperatura }}}
															 </td>
															...
															<tr>
															 <td>
															   <label for="pulsaciones" class="col-sm-3 control-label"> Pulsaciones </label>
															 </td>
															 <td>
															   {{{ $data->pulsaciones }}}
															 </td>

    ...
    <div class="white-box">
      ...
      <div class="pull-left">
        <?php if(Auth::user()->permisos->addRecord == 1) { ?>
          <a href="{{ url('/admin/asistentes/add') }}" class="btn btn-info ">
            <i class="fa fa-plus fa-2x"></i><br/>Nuevo</a>
        <?php } ?>
      </div>

      <div class="pull-right">
        <a href="{{ url('/admin/asistentes/excel' . $query) }}" class="btn btn-success" title="Exportar a Excel">
          <i class="fa fa-copy fa-2x"></i><br/>E. Excel
        </a>

        <a href="{{ url('/admin/asistentes/pdf' . $query) }}" class="btn btn-danger" title="Exportar a PDF">
            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-md-4 col-sm-4 text-center">
                      <a href="{{{ url('admin/asistentes/view/' . $value->id) }}}">
                      <?php if($value->fotografia) { ?>
                        <img src="{{{ asset('uploads/asistentes/' . $value->fotografia) }}}" alt="user" class="img-circle img-responsive">
                      <?php } else { ?>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="pull-right">
                        <?php if(Auth::user()->permisos->editRecord == 1) { ?>
                          <a title="Actualizar Informacion" href="{{ url('admin/asistentes/edit/' . $value->id)}}" class="btn btn-twitter waves-effect waves-light">

		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body" style="padding:0px;">
				...
				<?php if($data->fotografia) { ?>
								data-default-file="<?= asset('/uploads/asistentes/' . $data->fotografia); ?>"
				<?php } ?>
				/>
	...
	<div class="panel panel-default">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<?php $selcts = explode(',',$data->doctores);?>
				<!-- Password Start -->
				<div class="col-md-12">
				 <div class="form-group">
					<label for="password" class="control-label"> Doctores Asignados </label>
					<select class="form-control chosen-select" name="doctores[]" id="doctores" multiple>
						<?php foreach($doctores as $value) { ?>
							<option value="<?php echo $value->id; ?>" <?php if(in_array($value->id,$selcts)) { echo 'selected'; }?>><?php echo $value->nombre; ?></option>
						<?php } ?>
					</select>
				 </div>
				</div>

		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<div class="col-md-12">
			      ...
			      <div class="label label-danger">{{ $errors->first("imagen") }}</div>
			    </div>
			  </div>
				<!-- Logotipo End -->
					 ...
					 <div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" name="impuesto" id="impuesto"
										 value="{{{ isset($data->impuesto ) ? round($data->impuesto,2)  : old('impuesto') }}}">
							<span class="input-group-addon"> % </span>
						</div>
						<div class="label label-danger">{{ $errors->first("impuesto") }}</div>
					 </div>
					</div>
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" name="hospedaje" id="hospedaje"
 										value="{{{ isset($data->hospedaje ) ? $data->hospedaje  : old('hospedaje') }}}">
				 ...
				 <div class="form-group">
				  <label for="twitter" class="control-label"> Twitter </label>
					<div class="input-group">
						...
						<input type="text" class="form-control" id="twitter" name="twitter" value="{{{ isset($data->twitter ) ? $data->twitter  : old('twitter') }}}">
					 </div>
				 ...
				 <div class="form-group">
				  <label for="facebook" class="control-label"> Facebook </label>
					<div class="input-group">
						...
						<input type="text" class="form-control" id="facebook" name="facebook" value="{{{ isset($data->facebook ) ? $data->facebook  : old('facebook') }}}">
					 </div>
				 ...
				 <div class="form-group">
				  <label for="instagram" class="control-label"> Instagram </label>
					<div class="input-group">
						...
						<input type="text" class="form-control" id="instagram" name="instagram" value="{{{ isset($data->instagram ) ? $data->instagram  : old('instagram') }}}">
					 </div>

		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body" style="padding: 0px">
				...
				<?php if($data->fotografia) { ?>
								data-default-file="<?= asset('/uploads/medicos/' . $data->fotografia); ?>"
				<?php } ?>
				/>
	...
	<div class="panel panel-default">
		...
		<div class="panel-wrapper collapse in" aria-expanded="true">
			<div class="panel-body">
				...
				<div class="col-md-12">
				 <div class="form-group">
					 <label for="domicilio" class="control-label"> Domicilio del Medico </label>
					<textarea rows="3" class="form-control" id="domicilio" name="domicilio">{{{ isset($data->domicilio ) ? $data->domicilio  : old('domicilio') }}}</textarea>
...
<style> .dropify-wrapper{ height: 455px; } </style>

...
<div class="row">
  ...
  <div class="col-sm-12">
    ...
    <div class="white-box">
      ...
      <div class="pull-left">
        <a href="{{ url('/admin/ordenes/add') }}" class="btn btn-info ">
      ...
      <div class="pull-right">
        <a href="{{ url('/admin/ordenes/excel' . $query) }}" class="btn btn-success" title="Exportar a Excel">
          <i class="fa fa-copy fa-2x"></i><br/>E. Excel
        </a>

        <a href="{{ url('/admin/ordenes/pdf' . $query) }}" class="btn btn-danger" title="Exportar a PDF">
            ...
            <div class="table-responsive">
              ...
              <table class="table display" id="table-content">
                <thead>
                  <tr>
                    <?php $sortSym=isset($_GET["order"]) && $_GET["order"]=="asc" ? "up" : "down"; ?><th>Tipo</th>
						<th>Medico_id</th><th>Paciente_id</th><th>Fecha_solicitud</th>
                ...
                <?php foreach($data as $value) { ?>
                 ...
                 <td>
												           <a href="<?php echo url("/"); ?>/admin/ordenes/edit/<?php echo $value->id; ?>" title="Edit" data-toggle="tooltip">
												            <i class="fa fa-edit fa-lg text-info m-r-10"></i>
												           </a>
												           <button type="button" data-toggle="tooltip" class="delete" data-url="<?php echo url("/"); ?>/admin/ordenes/baja/<?php echo $value->id; ?>" data-title="Eliminar ordenes" style="border:0px; background:none">

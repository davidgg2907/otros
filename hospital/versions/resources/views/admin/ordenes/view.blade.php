            ...
            {{ csrf_field() }}
              <table class='table table-bordered' style='width:70%;' align='center'>
										    ...
										    <!-- Paciente_id End -->
															...
															<tr>
															 <td>
															   <label for="fecha_solicitud" class="col-sm-3 control-label"> Fecha_solicitud </label>
															 </td>
															 <td>
															...
															<tr>
															 <td>
															   <label for="fecha_aplicacion" class="col-sm-3 control-label"> Fecha_aplicacion </label>
															 </td>
															 <td>

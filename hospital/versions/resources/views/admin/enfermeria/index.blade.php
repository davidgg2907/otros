    ...
    <div class="white-box">
      ...
      <div class="pull-left">
        <?php if(Auth::user()->permisos->addRecord == 1) { ?>
          <a href="{{ url('/admin/enfermeria/add') }}" class="btn btn-info ">
            <i class="fa fa-plus fa-2x"></i><br/>Nuevo</a>
        <?php }?>
      </div>

      <div class="pull-right">
        <a href="{{ url('/admin/enfermeria/excel' . $query) }}" class="btn btn-success" title="Exportar a Excel">
          <i class="fa fa-copy fa-2x"></i><br/>E. Excel
        </a>

        <a href="{{ url('/admin/enfermeria/pdf' . $query) }}" class="btn btn-danger" title="Exportar a PDF">
            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-md-4 col-sm-4 text-center">
                      <a href="{{{ url('admin/enfermeria/view/' . $value->id) }}}">
                      <?php if($value->fotografia) { ?>
                        <img src="{{{ asset('uploads/enfermeras/' . $value->fotografia) }}}" alt="user" class="img-circle img-responsive">
                      <?php } else { ?>
                    ...
                    <div class="col-md-8 col-sm-8">
                        <a href="{{{ url('admin/enfermeria/view/' . $value->id) }}}">
                          <h3 class="box-title m-b-0" title="{{ $value->nombre }}">{{ substr($value->nombre,0,20) }}</h3> <small>{{ $value->especialidad }}</small>
                        </a>
                        <p> </p>
                        <address>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="pull-right">
                        <?php if(Auth::user()->permisos->editRecord == 1) { ?>
                          <a title="Actualizar Informacion" href="{{ url('admin/enfermeria/edit/' . $value->id)}}" class="btn btn-twitter waves-effect waves-light">

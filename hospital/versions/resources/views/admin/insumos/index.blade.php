  ...
  <div class="col-sm-12">
    ...
    <div class="white-box">
      ...
      <div class="pull-right">
        <a href="{{ url('/admin/insumos/excel' . $query) }}" class="btn btn-success" title="Exportar a Excel">
          <i class="fa fa-copy fa-2x"></i><br/>E. Excel
        </a>

        <a href="{{ url('/admin/insumos/pdf' . $query) }}" class="btn btn-danger" title="Exportar a PDF">

...
<div class="row">
  ...
  <div class="col-sm-12">
    ...
    <div class="white-box">
      ...
      <div class="pull-left">
        <a href="{{ url('/admin/citas/add') }}" class="btn btn-info ">
          ...
          <div class="panel-body">
            <div class="table-responsive">
              ...
              <table class="table display" id="table-content">
                <thead>
                  <tr>
                    <?php $sortSym=isset($_GET["order"]) && $_GET["order"]=="asc" ? "up" : "down"; ?><th>Paciente_id</th><th>Consultorio_id</th><th>Medico_id</th><th>Enfermera_id</th><th>Fecha</th>
						<th>Hora</th>
						<th>Comentarios</th>
						<th>Status</th>
                ...
                <?php foreach($data as $value) { ?>
                 ...
                 <td>
												           <a href="<?php echo url("/"); ?>/admin/citas/edit/<?php echo $value->id; ?>" title="Edit" data-toggle="tooltip">
												            <i class="fa fa-edit fa-lg text-info m-r-10"></i>
												           </a>
												           <button type="button" data-toggle="tooltip" class="delete" data-url="<?php echo url("/"); ?>/admin/citas/baja/<?php echo $value->id; ?>" data-title="Eliminar citas" style="border:0px; background:none">

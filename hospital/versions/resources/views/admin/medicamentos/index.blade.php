  ...
  <div class="col-sm-12">
    ...
    <div class="white-box">
      ...
      <div class="pull-right">
        <a href="{{ url('/admin/medicamentos/excel' . $query) }}" class="btn btn-success" title="Exportar a Excel">
          <i class="fa fa-copy fa-2x"></i><br/>E. Excel
        </a>

        <a href="{{ url('/admin/medicamentos/pdf' . $query) }}" class="btn btn-danger" title="Exportar a PDF">

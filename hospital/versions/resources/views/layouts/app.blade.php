...
<head>
    ...
    <!-- color CSS -->
    <link href="{{ asset('themes/css/colors/blue-dark.css') }}" id="theme" rel="stylesheet">
    <!-- chosen CSS -->
    ...
    <!-- summernotes CSS -->
    <link href="{{ asset('themes/plugins/bower_components/summernote/dist/summernote.css') }}" rel="stylesheet" />
    <!-- Calendar CSS -->
    <link href="{{ asset('themes/plugins/bower_components/calendar/dist/fullcalendar.css') }}" rel="stylesheet" />

    <!-- picker CSS -->
    <link href="{{ asset('themes/plugins/bower_components/pickadate/themes/classic.css') }}" rel="stylesheet">
    <link href="{{ asset('themes/plugins/bower_components/pickadate/themes/classic.date.css') }}" rel="stylesheet">
    <link href="{{ asset('themes/plugins/bower_components/pickadate/themes/classic.time.css') }}" rel="stylesheet">

    <!-- Custom select select2-->
    <link href="{{ asset('themes/plugins/bower_components/custom-select/custom-select.css') }}" rel="stylesheet" type="text/css" />
            ...
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part">
                  <a class="logo" href="{{ url('/') }}">
                    ...
                    <span class="hidden-xs"><strong>{{$empresa->nombre}}</strong></span>
                  </a>
                </div>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                  <li class="dropdown">
                      <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#">
                        <img src="{{ $fotografia }}" alt="user-img" width="36" class="img-circle">
                        <b class="hidden-xs">{{{ Auth::user()->name }}}</b>
                      </a>
                      <ul class="dropdown-menu dropdown-user animated flipInY">
                          <li><a href="{{ url('admin/users/perfil') }}"><i class="ti-user"></i>  Mi Perfil</a></li>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="user-pro">
                        <a href="#" class="waves-effect">
                          <img src="{{ $fotografia }}" alt="user-img" class="img-circle">
                    ...
                    <li> <a href="{{ url('/') }}" class="waves-effect"><i class="fa fa-dashboard fa-lg"></i> <span class="hide-menu">Escritorio</span></a></li>
...
<!-- jQuery peity -->
<script src="{{ asset('themes/plugins/bower_components/peity/jquery.peity.min.js') }}"></script>
<script src="{{ asset('themes/plugins/bower_components/peity/jquery.peity.init.js') }}"></script>
...
<script src="{{ asset('themes/plugins/bower_components/summernote/dist/summernote.min.js') }}"></script>
...
<!-- picker JS -->
<script src="{{{ asset('themes/plugins/bower_components/pickadate/picker.js') }}}"></script>
<script src="{{{ asset('themes/plugins/bower_components/pickadate/picker.date.js') }}}"></script>
<script src="{{{ asset('themes/plugins/bower_components/pickadate/picker.time.js') }}}"></script>

<!-- custom-select select2-->
<script src="{{ asset('themes/plugins/bower_components/custom-select/custom-select.min.js') }}" type="text/javascript"></script>

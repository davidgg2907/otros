...
<script>
  ...
  Morris.Donut({
    ...
    data: [{
        label: "Cigarros",
        value: {{ (int)\App\admin\Resultados::promedioPreguntas(0,$data->id,121) }},
    }, {
        label: "Pipa",
        value: {{ (int)\App\admin\Resultados::promedioPreguntas(0,$data->id,122) }},
    }, {
        label: "Puros",
        value: {{ (int)\App\admin\Resultados::promedioPreguntas(0,$data->id,123) }},
    }],
    resize: true,
    colors:['#20a42f', '#2091a4', '#d07244', '#d0c796', '#b696d0']
  ...
  Morris.Donut({
    ...
    data: [{
        ...
        value: {{ (int)\App\admin\Resultados::promedioPreguntasRespuestas(0,$data->id,127,558) }},
    }, {
        label: "Igual Que Siempre",
        value: {{ (int)\App\admin\Resultados::promedioPreguntasRespuestas(0,$data->id,127,559) }},
    }, {
        label: "Más De Lo Habitual",
        value: {{ (int)\App\admin\Resultados::promedioPreguntasRespuestas(0,$data->id,127,560) }},
    }],
    resize: true,
    colors:['#20a42f', '#2091a4', '#d07244', '#d0c796', '#b696d0']
